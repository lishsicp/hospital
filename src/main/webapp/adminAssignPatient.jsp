                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">
                                            ...
                                            <button type="button" class="btn btn-outline-primary btn-sm"
                                                    ...
                                                    onclick="<c:set var="patient" value="${p}"/>"><fmt:message
                                                    key="patient.edit"/>
                                            </button>
                                            <!-- Modal -->
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel${i.index}">
                                                                <fmt:message key="patient.edit"/></h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input class="form-control" type="date"
                                                                           ...
                                                                           onclick="deleteInvalid(this)"
                                                                           id="date_of_birth"
                                                                           value="<ctg:dateFormat date="${p.dateOfBirth}" locale="en_US"/> "
                                                                           required>
                                                                    <div class="text-danger invalid-feedback"></div>
                                                                </div>
                                                                <div class="mb-3">
